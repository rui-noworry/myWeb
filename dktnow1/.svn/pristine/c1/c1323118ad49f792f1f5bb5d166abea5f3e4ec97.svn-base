...
public class MyContants {
	...
	public final static String DO_HTTP_CLASSHOUR_PUB = "do_http_pub_classhour";
	...
	public final static String DO_HTTP_TEACH_ACTIVITY_PUSH = "do_http_pub_activity";
	public final static String DO_HTTP_PUB_HOMEWORK = "do_http_pub_homework";
	public final static String DO_HTTP_HOMEWORK_STATS = "do_http_student_homework_stats_list";
	public final static String DO_HTTP_STUDENT_HOMEOWRK = "do_http_student_homework_list";
	public final static String DO_HTTP_HOMEWORK_STUDENTS = "do_http_homework_students";
	public final static String DO_HTTP_TEACH_CLASSWORK_STUDENT_ANSWER = "do_http_classwork_student_answer";
	public final static String DO_HTTP_TEACH_CLASSWORK_STATS = "do_http_classwork_stats";
	public final static String DO_HTTP_STUDENT_CLASSWORK = "do_http_student_classwork";
	public final static String DO_HTTP_ISERT_PICTURE = "do_http_insert_picture";
	public final static String DO_HTTP_STUDENT_MSG = "do_http_student_msg";
	public final static String DO_HTTP_TEACH_CLASSWORK_PUSH = "do_http_classwork_push";
	public final static String DO_HTTP_STUDENTS_LIST = "do_http_students_list";
