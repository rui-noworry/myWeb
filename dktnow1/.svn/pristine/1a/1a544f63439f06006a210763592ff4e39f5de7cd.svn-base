...
class ClientAction extends BaseAction {
    ...
    public function iosPath() {
        ...
        // 生成代码
        $str = '<?xml version="1.0" encoding="UTF-8"?><!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd"><plist version="1.0"><dict><key>items</key><array><dict><key>assets</key><array><dict><key>kind</key><string>software-package</string><key>url</key><string>http://' . $_SERVER['HTTP_HOST'] . '/Uploads/Config/ios_' . $version[$status] . '_version.ipa</string></dict></array><key>metadata</key><dict><key>bundle-identifier</key><string>com.mink.mcute.dkt' . $version[$status] . '</string><key>bundle-version</key><string>1.0</string><key>kind</key><string>software</string><key>title</key><string>大课堂' . $language[$status] . '端</string></dict></dict></array></dict></plist>';
