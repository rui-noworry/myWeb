...
import dkt.student.net.UploadFile.MyThread;
...
public class StudentUploadFile {
	 ...
	 */
	public StudentUploadFile(String strurl, UploadHandler handler, HashMap<String,Object> map,String dbname){
		this.map = map;
		this.dbname = dbname;
	...
	private void uploadFile() {
		...
		try {
			...
			//update url
			dos.writeBytes(twoHyphens + BOUNDARY + end);
			dos.writeBytes("Content-Disposition: form-data; name=\"stu_notes\"; filename=\""
