...
import dkt.student.view.popu.NoteListGroupPopu;
import dkt.student.view.popu.NoteListNewPopu;
...
public class NoteListActivity extends Activity implements NoteAdapterChangeListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		app.setJiePView(findViewById(R.id.note_list_back_btn));
		addFun();
	...
	private void setGridView() {
		...
		for (int i = 0; i < notelist.size(); i++) {
			...
			map.put("time", notelist.get(i).getNoteCreateTime());
			map.put("pic", getDrawableNew(notelist.get(i).getNotePic()));
			System.out.println(i+"==="+notelist.get(i).getNoteName());
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				System.out.println(notelist.get(arg2).getNotePath());
