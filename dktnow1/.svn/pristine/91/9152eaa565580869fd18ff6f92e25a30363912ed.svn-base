...
class TagLibHtml extends TagLib {
    ...
    protected $tags   =  array(
        ...
        'editor'=>array('attr'=>'id,name,style,width,height,content,type','close'=>1),
    ...
    public function _list($attr)
    {
        ...
        $parseStr    .= '</tr></volist>';
        //$parseStr    .= '</tr></volist><tr><td height="5" colspan="'.$colNum.'" class="bottomTd"></td></tr>';
        $parseStr    .= '</table>';
        $parseStr    .= "\n<!-- Think 系统列表组件结束 -->\n";
        return $parseStr;
    }
