...
<div title="课程表" class="syl_cour">
    ...
    <div>
        <span attr="0">无</span>
        <?php if(is_array($courseType)): $i = 0; $__LIST__ = $courseType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ct): $mod = ($i % 2 );++$i;?><span attr="<?php echo ($key); ?>"><?php echo ($ct); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
</div>
