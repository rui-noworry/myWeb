...
<link rel="stylesheet" type="text/css" href="__PUBLIC__/Css/Home/course.css" />
    ...
    <!--
        $(function() {
            ...
            // 页面开始加载时便加载默认的年级
            listGrade("<?php echo ($data[school][0]); ?>", 'coGrade', 1);
    ...
    <div class="tag_list" title="添加标签">
        <ul class="tag_tag">
            ...
            <li class="bztaglist coType">
                <label>学段：</label>
                <div>
                    <?php if(is_array($data["school"])): $i = 0; $__LIST__ = $data["school"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><span class="hand <?php if(($key) == "0"): ?>on<?php endif; ?>" rel="<?php echo ($vo); ?>"><?php echo (gettypenamebyid($vo,'SCHOOL_TYPE')); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </li>
            ...
            <li class="bztaglist coSubject">
                <label>学科：</label>
                <div>
                    <?php if(is_array($data["subject"])): $i = 0; $__LIST__ = $data["subject"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><span class="hand" rel="<?php echo ($vo); ?>" ><?php echo (gettypenamebyid($vo,'COURSE_TYPE')); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </li>
