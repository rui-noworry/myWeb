...
<div class="warp">
    ...
    <div class="user fl">
        <div class="user_menu">
             <?php if(is_array($secondList)): $i = 0; $__LIST__ = $secondList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$selist): $mod = ($i % 2 );++$i;?><a href="__APPURL__<?php echo ($selist['sn_url']); ?>" <?php if(($selist["sn_name"]) == "Student"): ?>class="selected"<?php endif; ?>><?php echo ($selist['sn_title']); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
        <div class="filter">
            <div class="tools fl">
        ...
        <div class="AuthStudent_list fl" id="studentList">
            <div class="_caption _ptitle t_caption">
                <ul>
                    <li class="_tcheck ch_nav"><input type="checkbox" onclick="CheckAll('studentList')"></li>
