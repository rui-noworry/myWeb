...
//            return ceil($this->dateDiff($time,$precision)).$_diff[$precision].'前';
            return ceil($this->dateDiff($time,$precision)).$precision.' ago';
        }
        $diff = abs($this->parse($time) - $this->date);
//        static $chunks = array(array(31536000,'y'),array(2592000,'M'),array(604800,'w'),array(86400,'d'),array(3600 ,'h'),array(60,'m'));
        static $chunks = array(array(31536000,'y'),array(2592000,'M'),array(604800,'w'),array(86400,'d'),array(3600 ,'h'),array(60,'m'),array(1,'s'));
        $count =0;
        $since = '';
