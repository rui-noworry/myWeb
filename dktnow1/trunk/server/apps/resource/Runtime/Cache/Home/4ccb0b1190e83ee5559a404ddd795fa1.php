...
<!--load href="__PUBLIC__/Js/Home/scroll.js" /-->
<script type="text/javascript">
<!--
    $(function() {
...
<div class="warp">
    <div class="main_left">
        ...
        <div class="res_list fl">
            <?php if(($txt) != ""): ?><ul class="show_more">
                    <li><?php echo ($txt); ?></li>
                </ul><?php endif; ?>
            <div class="more_res_list fl">
                <div class="mould">
                    <?php if(($res["list"]) != ""): ?><ul>
                            <?php if(is_array($res["list"])): $i = 0; $__LIST__ = $res["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$re): $mod = ($i % 2 );++$i;?><li>
                                    <a class="res_cover" target="_blank" href="__APPURL__/Resource/index/id/<?php echo ($re["re_id"]); ?>"><img src="<?php echo ($re["re_img"]); ?>"/></a>
                                    <a class="res_title" target="_blank" href="__APPURL__/Resource/index/id/<?php echo ($re["re_id"]); ?>" title="<?php echo ($re["re_title"]); ?>"><?php echo ($re["re_title"]); ?></a>
                                    <span><?php echo ($re["a_nickname"]); ?></span>
                                    <span><i><?php echo ($re["re_download_points"]); ?></i>积分</span>
                                </li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    <div class="page"><?php echo ($res["page"]); ?></div>
                    <?php else: ?>
                        <ul class="column2">
                            <span class="alert">暂无资源</span>
                        </ul><?php endif; ?>
                </div>
            </div>
        </div>
