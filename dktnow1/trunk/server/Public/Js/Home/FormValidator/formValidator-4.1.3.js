...
$.formValidator = 
{
	...
	initConfig : function(controlOptions)
	{
        ...
        $.ajax({async:false,type: "GET",url: themedir+settings.theme+"/theme.js",dataType: "script",
		...
		if($.support.leadingWhitespace)
		{
			...
			css.rel="stylesheet";
			css.type="text/css";
			css.href=themedir+settings.theme+"/style.css";
		...
		else
		{
			...
			var styCss = "@import url('"+themedir+settings.theme+"/style.css');";
