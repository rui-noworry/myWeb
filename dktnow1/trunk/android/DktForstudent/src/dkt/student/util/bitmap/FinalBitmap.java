package dkt.student.util.bitmap;
...
import dkt.student.util.bitmap.core.BitmapCache;
import dkt.student.util.bitmap.core.BitmapCommonUtils;
import dkt.student.util.bitmap.core.BitmapDisplayConfig;
import dkt.student.util.bitmap.core.BitmapProcess;
import dkt.student.util.bitmap.display.Displayer;
import dkt.student.util.bitmap.display.SimpleDisplayer;
import dkt.student.util.bitmap.download.Downloader;
import dkt.student.util.bitmap.download.SimpleHttpDownloader;
...
public class FinalBitmap {
	...
	public void display( ImageView imageView,String uri){
		...
		doDisplay(imageView,MyContants.HTTP_PREFIX + service_ip +uri,null);
	}
